  ...
  $.extend(Plugin.prototype, {
    ...
    glitch: function () {
      ...
      if (this.settings.destroy === true) {
        ...
        if (
          $(el).siblings().hasClass("el-front-1") ||
          $(el).siblings().hasClass("front-3") ||
          $(el).siblings().hasClass("front-2")
        ) {
        ...
        if (this.settings.blend === true) {
          ...
          cloneEl
            .insertAfter(el)
            .addClass("front-3")
            .css({ "z-index": zIndexStart + 3, "mix-blend-mode": this.settings.blendModeType }); // , 'mix-blend-mode': 'hard-light'
          blendElem();
        }
        ...
        if (this.settings.glitch === true) {
          ...
          cloneEl
            .insertAfter(el)
            .addClass("front-2")
            .css({ "z-index": zIndexStart + 2 });

          // add class middle to elem
          $(".back")
            .next()
            .addClass("front-1")
            .css({ "z-index": zIndexStart + 1 });
            //   @ts-ignore
